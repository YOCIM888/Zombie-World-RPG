...
export function handleLeaderAssassinate() {
  ...
  if (!isQuestDone("leaderQuest3")) {
    setStory("你看着首领的背影，心中回想起国王的命令……\n\n但你突然意识到，首领身上还藏着许多秘密。暗杀他将无法完成阵地首领的任务链。\n\n确定要继续吗？");
    setPhase("leader_assassinate_warn");
    setOptions([
      { text: "继续暗杀", action: "assassinate_confirm" },
