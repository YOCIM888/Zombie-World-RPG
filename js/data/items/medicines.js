export const MEDICINES = [
  ...
  { id: "止痛片", name: "止痛片", type: "medicine", effects: { sanity: 15, crash: -5 }, rarity: "uncommon" },
  { id: "镇静剂", name: "镇静剂", type: "medicine", effects: { sanity: 30 }, rarity: "uncommon" },
  ...
  { id: "improved_serum", name: "改良抗体针", type: "medicine", effects: { infection: -90 }, rarity: "myth" },
  { id: "zombie_gel", name: "丧尸凝胶", type: "medicine", effects: { infection: 2}, rarity: "myth" },
];
